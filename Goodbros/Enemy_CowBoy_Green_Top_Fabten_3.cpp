...
Enemy_CowBoy_Green_Top_Fabten_3::Enemy_CowBoy_Green_Top_Fabten_3(float x, float y) : Enemy(x, y)
{
...
void Enemy_CowBoy_Green_Top_Fabten_3::Move()
{
...
void Enemy_CowBoy_Green_Top_Fabten_3::Die()
{
	collider->type = COLLIDER_NONE;
