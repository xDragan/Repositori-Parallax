...
Enemy_CowBoy_Green_Top_Small::Enemy_CowBoy_Green_Top_Small(float x, float y) : Enemy(x, y)
{
	...
	spawnup.PushBack({ 1127, 2981, 20, 20 });
	spawnup.PushBack({ 1144, 2981, 20, 20 });
	spawnup.speed = 0.10f;
	spawnup.loop = false;



	spawndown.PushBack({ 1144, 2981, 20, 20 });
	spawndown.PushBack({ 1127, 2981, 20, 20 });
	spawndown.PushBack({ 1110, 2981, 20, 20 });
	spawndown.PushBack({ 1094, 2912, 20, 20 });
