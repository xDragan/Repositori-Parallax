...
Enemy_CowBoy_Green_Top_Fabten_2::Enemy_CowBoy_Green_Top_Fabten_2(float x, float y) : Enemy(x, y)
{
...
void Enemy_CowBoy_Green_Top_Fabten_2::Move()
{
...
void Enemy_CowBoy_Green_Top_Fabten_2::Die()
{
	collider->type = COLLIDER_NONE;
